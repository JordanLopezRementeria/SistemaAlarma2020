...
public class UsuarioBaseSQLite extends SQLiteOpenHelper {
    ...
    private static final String COL_FK = "IDCOLMENAR";
   ...
   private static final String CREATE_TABLE = "CREATE TABLE " + TABLA + " (" +
    ...
    private static final String CREATE_TABLE2 = "CREATE TABLE " + TABLA2 + " (" +
            COL_ID2 + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COL_FK + " INTEGER NOT NULL, " + COL_NOMBRE2 + " TEXT NOT NULL, " + COL_INCIDENCIA + " TEXT, FOREIGN KEY(IDCOLMENAR) REFERENCES TABLA3(IDAPIARIO))";

    //tabla apiario
    private static final String CREATE_TABLE3 = "CREATE TABLE " + TABLA3 + " (" +
            COL_ID3 + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COL_FK2 + " INTEGER NOT NULL, " + COL_NOMBRE3 + " TEXT NOT NULL,  FOREIGN KEY(IDUSUARIO) REFERENCES TABLA(ID))";
