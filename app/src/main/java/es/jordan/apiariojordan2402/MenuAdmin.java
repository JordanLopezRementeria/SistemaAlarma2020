...
public class MenuAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // texto.setText("Bienvenid@ "+usuarioPasado.getNombre());
        ...
        cerrar2.setOnClickListener(new View.OnClickListener() { //on click de desconectar
            @Override
            public void onClick(View v) {
    ...
    public void xmlToJava()
    {
        ...
        cerrar2=(Button)findViewById(R.id.cerrarUsuario2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) { //obtiene el click de cada menu
        ...
        switch(id) {
            ...
            case R.id.item1: //al pinchar en el menu va aqui
                Intent llamada=new Intent(MenuAdmin.this, MenuAdminApicultor.class);
                startActivity(llamada);
                return true;
