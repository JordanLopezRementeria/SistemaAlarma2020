...
public class MenuApicultor extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_apicultor);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                Intent llamada=new Intent(MenuApicultor.this, ApiarioColmena.class);
        ...
        lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() { //pulsar largo
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1, final int position, long arg3) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(MenuApicultor.this);
        ...
        imagenBorrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(MenuApicultor.this);//check borrar
                alert.setTitle("Advertencia");
                alert.setCancelable(true);
                alert.setIcon(R.drawable.eliminar1_foreground);
                String nombreAborrar=(itemSeleccionado2.nombre);
        ...
        cerrar4.setOnClickListener(new View.OnClickListener() { //on click de desconectar
            @Override
            public void onClick(View v) {
                ...
                alert.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent llamada=new Intent(MenuApicultor.this, MainActivity.class);
                        startActivity(llamada);
                    }
                });
                alert.create().show();
    ...
    {
        editText =(EditText)findViewById(R.id.input_text5);
        editNombreApicultor =(EditText)findViewById(R.id.nombreApicultorXML5);
        editNombreApiario =(EditText)findViewById(R.id.nombreApiarioXML5);
        //hablarAhoraBoton=findViewById(R.id.speak_now);
        lv = (ListView)findViewById(R.id.listView2);
        imagenAñadir = (ImageView) findViewById(R.id.imagenAñadirXML5);
        imagenListar = (ImageView) findViewById(R.id.imagenlistarXML5);
        imagenBorrar = (ImageView) findViewById(R.id.imagenBorrarXML5);
        cerrar4=(Button)findViewById(R.id.cerrarUsuario4);
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) { //obtiene el click de cada menu
        ...
        switch(id) {
            ...
            case R.id.item1: //al pinchar en el menu va aqui
                Intent llamada=new Intent(MenuApicultor.this, MenuApicultor2.class);
                startActivity(llamada);
                return true;
